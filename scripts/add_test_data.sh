...
create_sample_appointments() {
    ...
    # Sample appointments with different regions (mix of physical and virtual)
    appointments=(
        # Physical appointments
        '{"customer": {"name": "John Smith", "email": "john.smith@example.com", "phone": "469-555-2001"}, "location": {"latitude": 33.1811789, "longitude": -96.6291685, "postal_code": "75069", "street_name": "Bay Street", "street_number": "100", "city": "McKinney", "state_province": "Texas", "country": "USA"}, "booking": {"booking_date": "2025-09-23", "booking_time": "09:00:00"}, "booking_type": "physical", "region_name": "North Texas", "call_center_agent": {"name": "Sarah Johnson", "email": "sarah.cc@callcenter.com"}}'
        '{"customer": {"name": "Maria Lopez", "email": "maria.lopez@example.com", "phone": "956-555-2002"}, "location": {"latitude": 26.1936248, "longitude": -98.2118124, "postal_code": "78502", "street_name": "Broadway", "street_number": "500", "city": "McAllen", "state_province": "Texas", "country": "USA"}, "booking": {"booking_date": "2025-09-23", "booking_time": "10:30:00"}, "booking_type": "physical", "region_name": "South Texas", "call_center_agent": {"name": "Mike Rodriguez", "email": "mike.cc@callcenter.com"}}'
        '{"customer": {"name": "Robert Davis", "email": "robert.davis@example.com", "phone": "903-555-2003"}, "location": {"latitude": 32.3513, "longitude": -95.3011, "postal_code": "75702", "street_name": "Main Street", "street_number": "200", "city": "Tyler", "state_province": "Texas", "country": "USA"}, "booking": {"booking_date": "2025-09-23", "booking_time": "14:00:00"}, "booking_type": "physical", "region_name": "East Texas", "call_center_agent": {"name": "Lisa Chen", "email": "lisa.cc@callcenter.com"}}'
        '{"customer": {"name": "Jennifer Wilson", "email": "jennifer.wilson@example.com", "phone": "915-555-2004"}, "location": {"latitude": 31.7619, "longitude": -106.485, "postal_code": "79901", "street_name": "Mesa Street", "street_number": "300", "city": "El Paso", "state_province": "Texas", "country": "USA"}, "booking": {"booking_date": "2025-09-23", "booking_time": "11:00:00"}, "booking_type": "physical", "region_name": "West Texas", "call_center_agent": {"name": "David Thompson", "email": "david.cc@callcenter.com"}}'
        '{"customer": {"name": "Michael Brown", "email": "michael.brown@example.com", "phone": "512-555-2005"}, "location": {"latitude": 30.2672, "longitude": -97.7431, "postal_code": "78701", "street_name": "Congress Avenue", "street_number": "400", "city": "Austin", "state_province": "Texas", "country": "USA"}, "booking": {"booking_date": "2025-09-23", "booking_time": "15:30:00"}, "booking_type": "physical", "region_name": "Central Texas", "call_center_agent": {"name": "Amanda Walker", "email": "amanda.cc@callcenter.com"}}'
        
        # Virtual appointments (no location data needed)
        '{"customer": {"name": "Lisa Martinez", "email": "lisa.martinez@example.com", "phone": "469-555-3001"}, "booking": {"booking_date": "2025-09-24", "booking_time": "09:00:00"}, "booking_type": "virtual", "region_name": "North Texas", "call_center_agent": {"name": "Sarah Johnson", "email": "sarah.cc@callcenter.com"}}'
        '{"customer": {"name": "Carlos Rodriguez", "email": "carlos.rodriguez@example.com", "phone": "956-555-3002"}, "booking": {"booking_date": "2025-09-24", "booking_time": "10:30:00"}, "booking_type": "virtual", "region_name": "South Texas", "call_center_agent": {"name": "Mike Rodriguez", "email": "mike.cc@callcenter.com"}}'
        '{"customer": {"name": "Amanda Taylor", "email": "amanda.taylor@example.com", "phone": "903-555-3003"}, "booking": {"booking_date": "2025-09-24", "booking_time": "14:00:00"}, "booking_type": "virtual", "region_name": "East Texas", "call_center_agent": {"name": "Lisa Chen", "email": "lisa.cc@callcenter.com"}}'
        '{"customer": {"name": "Virtual Customer", "email": "virtual.customer@example.com", "phone": "800-555-3004"}, "booking": {"booking_date": "2025-09-24", "booking_time": "11:00:00"}, "booking_type": "virtual", "region_name": "Global", "call_center_agent": {"name": "Jennifer Lee", "email": "jennifer.cc@callcenter.com"}}'
        '{"customer": {"name": "Remote Client", "email": "remote.client@example.com", "phone": "512-555-3005"}, "booking": {"booking_date": "2025-09-24", "booking_time": "15:30:00"}, "booking_type": "virtual", "region_name": "Central Texas", "call_center_agent": {"name": "Amanda Walker", "email": "amanda.cc@callcenter.com"}}'
    )
...
main() {
    ...
    echo "  • 10 Sample appointments (5 physical + 5 virtual across regions)"
    echo ""
